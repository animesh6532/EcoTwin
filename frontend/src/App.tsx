...
export default function App() {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#050505] text-[#FFF3E5] antialiased font-sans overflow-x-hidden relative flex flex-col justify-between">
      {/* Premium cinematic background and overlays */}
      <BackgroundLayer />
